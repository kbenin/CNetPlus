...
!!!DAPAT 7 UNDER32SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
client-identifier 001a.0704.7f63
...
http://docwiki.cisco.com/wiki/Cisco32IOS32Voice32Troubleshooting32and32Monitoring32--32Tcl32IVR32Troubleshooting
...
no voice register pool 1
  voice register pool 1
    id mac 5e17.74d7.0959
    number 1 dn 1
    dtmf-relay sip-notify
    username 3271 password 3271
    codec g711ulaw
!
